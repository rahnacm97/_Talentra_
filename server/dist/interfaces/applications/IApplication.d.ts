export type ApplicationStatus = "pending" | "reviewed" | "rejected" | "accepted" | "interview" | "shortlisted" | "hired" | "all";
...
export interface EmployerApplicationAggResult extends IEmployerApplicationResponse {
    candidate: IEmployerApplicationResponse["candidate"];
}
export type CandidateExperience = NonNullable<NonNullable<IEmployerApplicationResponse["candidate"]>["experience"]>[number];
