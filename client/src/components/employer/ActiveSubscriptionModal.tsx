      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full relative overflow-hidden">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6 font-medium">
            You are currently subscribed to the <span className="text-indigo-600 font-bold uppercase">{currentPlan === 'enterprise' ? 'Annual' : 'Monthly'}</span> plan.
          </p>
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-xl p-4 mb-8 text-sm text-left">
            ...
            <ul className="mt-3 space-y-2 text-gray-600 list-disc list-inside">
              ...
              <li>Or you can contact our support team for an immediate plan change</li>
              <li>Check your <strong>Billing History</strong> below for the exact expiry date</li>
            </ul>
          </div>
