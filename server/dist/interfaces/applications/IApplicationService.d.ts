...
export interface ICandidateApplicationService {
    ...
    getApplicationsForCandidate(candidateId: string, filters?: {
        status?: "pending" | "reviewed" | "rejected" | "accepted" | "interview" | "shortlisted" | "hired" | "all" | undefined;
...
export interface IEmployerApplicationService {
    getApplicationsForEmployer(employerId: string, filters: {
        page?: number;
        limit?: number;
        search?: string;
        status?: string;
    ...
    updateApplicationStatus(employerId: string, applicationId: string, data: IApplicationStatusUpdatePayload): Promise<EmployerApplicationResponseDto>;
}
...
//# sourceMappingURL=IApplicationService.d.ts.map