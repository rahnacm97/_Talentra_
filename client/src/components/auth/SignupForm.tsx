...
//   const [userType, setUserType] = useState<SignupRequest["userType"]>("Candidate");
...
//           By creating an account, you're joining thousands of professionals finding their next opportunity.
//         </p>
//       </div>
//     </div>
//   );
